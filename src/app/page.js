    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      <section className="relative overflow-hidden px-6 py-20">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-xl text-base text-neutral-400 sm:text-lg">
                  ...
                  library. List your own room and earn — all in one
                  seamless platform.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                >
                  <div className="text-2xl font-semibold text-lime-200">
                    {stat.value}
                  </div>
          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
            <div className="absolute -inset-6 rounded-[32px] bg-lime-200/10 blur-3xl"></div>
            ...
            <div className="relative h-[520px] overflow-hidden rounded-[32px] border border-neutral-800 bg-neutral-900/40 shadow-[0_30px_80px_rgba(0,0,0,0.55)]">
              <Image
                src="/assets/classic-study-room-stockcake.jpg"
                alt="Study Room"
                width={960}
                height={720}
      ...
      <section className="relative overflow-hidden px-6 py-20">
        <div className="pointer-events-none absolute inset-0 opacity-40">
          <div className="absolute -right-40 bottom-10 h-[400px] w-[400px] rounded-full bg-emerald-400/5 blur-[120px]"></div>
        </div>
